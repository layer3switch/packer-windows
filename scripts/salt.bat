if not exist "C:\Windows\Temp\salt64.exe" (
  powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://docs.saltstack.com/downloads/Salt-Minion-2015.8.3-AMD64-Setup.exe', 'C:\Windows\Temp\salt64.exe')" <NUL
)
